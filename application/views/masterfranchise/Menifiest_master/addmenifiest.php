...
<style>
  ...
  <?php  unset($_SESSION['class']); unset($_SESSION['notify']); } ?>                             
						   <div class="row">                                           
                            <div class="col-12">
								<form role="form" action="<?= base_url('franchisem/insert-menifiest'); ?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row" >
									...
									<div class="col-sm-2"> 
										...
										<select name="destination_branch" class="form-control" id="destination_branch" required>
											...
											<option value ="<?= $franchise2->branch_name; ?>">To <?= $franchise2->branch_name; ?> Branch</option>
										   <?php foreach($franchise as $val){ ?>
											<option value = "<?= $val->customer_id; ?>">To <?= " ".$val->customer_name." ";?> Franchise</option>
										  <?php } ?>
										</select>
									</div>
								</div>

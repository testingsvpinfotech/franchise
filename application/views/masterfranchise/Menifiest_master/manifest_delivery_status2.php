               ...
               <div class="col-12 col-sm-12 mt-3">
                 <div class="card">
                   ...
                   <div class="card-body">
                     <div class="row"> 
                       <div class="col-12">
                         <form role="form" action="<?php echo base_url(); ?>master-franchise/view-internal-status" method="post" autocomplete="off">
                           <div class="form-row">
                             <div class="col-md-2">
                               <input type="text" class="form-control" name="filter_value" value="<?php if (!empty($_POST)) {
                             ...
                             <div class="col-sm-2">
                               ...
                               <a href="<?= base_url('master-franchise/view-internal-status');?>" class="btn btn-info">Reset</a>
                             </div>
                           </div>
                         </form>
                       </div>
                                     ...
                                     <?php
                                      ...
                                      ?>
                                           <tr>
                                             ...
                                             <td><?php ini_set('display_errors', '0');
ini_set('display_startup_errors', '0');
error_reporting(E_ALL); echo $value_d['eway_no']; ?></td>

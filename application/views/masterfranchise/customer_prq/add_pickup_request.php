                ...
                <div class="col-12 col-sm-12">
                    <div class="row">
                        <div class="col-12 col-md-6 mt-3">
                            ...
                            <form method="post" class="" action="<?php echo base_url(); ?>Master_Franchise_prq/pickup_request">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <a href="<?php echo base_url('Master_Franchise_prq/view_pickup_request');?>" class="btn btn-primary nexttab ml-auto">View All</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

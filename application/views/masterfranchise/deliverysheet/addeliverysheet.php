                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
						   ...
						   <div class="row">                                           
                            <div class="col-12">
								<form role="form" action="<?= base_url('master-franchise/insert-deliverysheet');?>" method="post" enctype="multipart/form-data">
...
echo date("Y-m-d H:i"); ?>">
								...
								<label class="col-sm-2 col-form-label">Rmark:</label>

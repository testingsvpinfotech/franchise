                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <form action="<?= base_url('master-franchise/pickup-in-scan'); ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-3 ml-3">
                                        <div class="box-footer">
                                           <textarea name="remark" placeholder="Commenets" class="form-control"></textarea><br>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
    ...
    $(document).ready(function() {
        $("#btn_search").click(function() {
            ...
            if (forwording_no != "") {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>Admin_franchise_Inscan/pickup_awb_scan",
                    type: 'POST',
                    dataType: "html",
                    data: {

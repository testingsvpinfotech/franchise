                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <form action="<?= base_url('master-franchise/single-delivery-update'); ?>" method="post">
                                    <input type="submit" id="btn_search" name="submit" style="float: right;" value="Search">
                                    <a href="<?= base_url('master-franchise/single-delivery-update');?>" style="color:blue;"> Reset</a>
                                    ...
                                    <br>
                                    <!--  col-sm-4-->
                                    <form action="<?= base_url('master-franchise/single-delivery-insert'); ?>" method="post">

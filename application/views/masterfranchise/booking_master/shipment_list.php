            ...
            <div class="card-body">
                <div class="row p-2">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                       <!-- <a href="<?php echo base_url();?>master_franchise/add-shipment"> <button type="button" class="btn btn-primary text-white mr-1">ADD Shipment</button></a> -->
                ...
                <?php if ($this->session->flashdata('notify') != '') { ?>
                    ...
                    <div class="table-responsive">
                        <table id="id1" class="display table  table-responsive table-striped table-bordered">
                            ...
                            <tr>
                                <td><?=  $count; ?></td>
                                <td> <a href="<?= base_url('master-franchise/edit-shipment/'.$value->booking_id); ?>" target="_blank" style="color:blue;"><?= $value->pod_no ;?> </a></td>
        ...
        //   alert(booking_id);
       	...
       	swal({
		  	...
		  	if (result.value){
		  		...
		  		$.ajax({
			   		url: baseurl+'Master_franchise_manager/cancel_shipment',
			    	type: 'POST',

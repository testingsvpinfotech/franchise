                ...
                <?php unset($_SESSION['class']);
                    ...
                    <table  class="display table  table-responsive table-striped table-bordered">
                            ...
                            <tr>                 
                                ...
                                <th>Utilized are marked in red</th>
                            </tr>
                            </thead>
                    </table> <br>
                    <form action="<?= base_url('Ms-franchise/awb-available-stock');?>" method="get" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <a href="<?= base_url('Ms-franchise/awb-available-stock');?>" class="btn btn-primary"><i class="fa fa-refresh" style="font-size:14px;"></i></a>
                            </div>
                        </div>
                        </form>
                        <br>

                    ...
                    <div class="col-12 col-sm-12 mt-3">
                        <div class="card">
                            <div class="card-header justify-content-between align-items-center">
                                <h4 class="card-title">Franchise In-Scan</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <form action="<?= base_url('franchise/franchise-in-scan'); ?>" method="post">
    ...
    $(document).ready(function() {
        $("#btn_search").click(function() {
            ...
            if (forwording_no != "") {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>Admin_franchise_Inscan/franchise_awb_scan",
                    type: 'POST',
                    dataType: "html",
                    data: {

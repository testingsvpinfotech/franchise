					...
					<div class="col-12 col-sm-12 mt-3">
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12">
										<form role="form" action="<?= base_url('franchise_bag/add-incoming-bag'); ?>"
											method="post">
											<div class="box-body">
										...
										<div class="form-group row">
											...
											<div class="col-sm-2">
												<input type="datetime-local" class="form-control" name="datetime"
													id="exampleInputEmail1" required value="<?php date_default_timezone_set('Asia/Kolkata');
													echo date("Y-m-d H:i"); ?>">
											</div>
										</div>
										<thead>
										...
										<tbody>
											...
											if (!empty($menifiest_data)) {
												foreach ($menifiest_data as $value) {
													...
													?>
													<tr>
														<td><input type="checkbox" <?php echo ($value->bag_recived > 0) ? 'disabled' : ''; ?> name="pod_no[]" checked value="<?= $value->pod_no ?>"></td>
														<td><?= $value->pod_no ?></td>
														...
														<?php $username = $this->session->userdata('customer_name');
														//  print_r($username);?>
														<td>
															<?= $username; ?>
														</td>

					...
					<div class="col-12 col-sm-12 mt-3">
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12">
										<form role="form" action="<?= base_url('franchise/add-incoming'); ?>"
											method="post">
											<div class="box-body">
															...
															if (!empty($menifiest)) {
																foreach ($menifiest as $row) {
																	...
																	if ($row->reciving_status == 0) {
																		?>
																		<option value="<?php echo $row->manifiest_id; ?>" <?php echo ($manifiest_id == $row->manifiest_id) ? 'selected' : ''; ?>>
								...
								<table class="table table-bordered table-striped">
									<form role="form" action="<?= base_url('franchise/add-incoming'); ?>" method="post">
										<div class="form-group row">
										...
										<tbody>
											...
											if (!empty($menifiest_data)) {
												foreach ($menifiest_data as $value) {
													...
													<tr>
														<td>
															<input type="checkbox" <?php echo ($value->reciving_status > 0) ? 'disabled' : ''; ?> checked name="bag_no[]"
																value="<?= $value->bag_no ?>">
														</td>
														<td>
															<?= $value->bag_no ?>
														...
														<td><textarea name="recived_nop" placeholder="Recived NOP" <?php echo ($value->reciving_status > 0) ? 'disabled' : ''; ?>></textarea>
														</td>
														<td><textarea name="balance_nop" placeholder="Balance NOP" <?php echo ($value->reciving_status > 0) ? 'disabled' : ''; ?>></textarea>
														</td>
														<?php
														...
														<?php
															...
															<td>Recieved</td>
														<?php } ?>
														<td><textarea name="note[]" placeholder="remark" <?php echo ($value->reciving_status > 0) ? 'disabled' : ''; ?>></textarea></td>

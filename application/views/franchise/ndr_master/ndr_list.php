            ...
            <div class="card-body">
                <div class="row p-2">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <button type="button" class="btn btn-outline-primary btn-sm mr-1">Export</button>
                        <button type="button" class="btn btn-outline-secondary btn-sm mr-1">Import</button>
                        <button type="button" class="btn btn-outline-success btn-sm  mr-1">Filter</button>
                    </div>
                  </div>
                <hr>
                    ...
                    <div class="table-responsive">
                        <table id="id1" class="display table  table-striped table-bordered">
                            ...
                            <tr>
                                <td></td>
                                <td>Customer</td>
                                <td><a style="color: #4c66fb;" target="_blank" href="orders/view/4969497">MN65</a></td>
                                <td>Sep 29, 2022</td>

                ...
                <div class="col-12 col-md-12 mt-3">
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="id1">
                               ...
                               <!-- <form  action="<?php echo base_url('franchise/update-shipment/'.$booking->booking_id);?>" method="POST" id="formSubmit"> -->
                <div class="row">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            if ($this->session->userdata('booking_date') != '') { ?>
                                                ...
                                                <input type="datetime-local" name="booking_date" readonly id="booking_date" class="form-control" value="<?= date('Y-m-d\TH:i:s', strtotime($booking->booking_date . ' ' . $booking->booking_time)) ; ?>">
                                            <?php
                                            } else { ?>
                                                <input type="datetime-local" name="booking_date" readonly id="booking_date" class="form-control" value="<?= date('Y-m-d\TH:i:s', strtotime($booking->booking_date . ' ' . $booking->booking_time)) ; ?>">
                                            <?php } ?>
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-8">
                                            <input type="text" name="awn" readonly class="form-control" readonly value="<?php echo $booking->pod_no ;?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control mode_dispatch" readonly name="mode_dispatch" id="mode_dispatch">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="special_instruction" readonly class="form-control my-colorpicker1"><?= $booking->special_instruction; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Risk Type<span class="compulsory_fields">*</span></label>
                                        <div class="col-sm-8">
                                            <select class="form-control" readonly name="risk_type" id="risk_type">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" readonly name="dispatch_details" id="dispatch_details">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" readonly name="doc_type" id="doc_typee">
                                                <option value="">-Select-</option>
                                    ...
                                    <div id="div_inv_row" style="display: none;">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" readonly name="invoice_no" id="invoice_no" value="<?= $booking->invoice_no ?>" class="form-control my-colorpicker1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Inv. Value<span class="compulsory_fields">*</span></label>
                                            <div class="col-sm-8">
                                                <input type="number" readonly name="invoice_value" id="invoice_value" value="<?= $booking->invoice_value ?>" class="form-control my-colorpicker1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Eway No</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="eway_no" readonly value="<?= $booking->eway_no ?>" minlength="12" maxlength="12" size="12" id="eway_no" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Eway Expiry date</label>
                                            <div class="col-sm-8">
                                                <input type="datetime-local" name="eway_expiry_date" value="<?= $booking->eway_expiry_date ?>" readonly id="eway_no" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8" id="credit_div">
                                            <select readonly class="form-control" name="customer_account_id" id="customer_account_id">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="sender_name" readonly id="sender_name" value="<?= $booking->sender_name ?>" class="form-control my-colorpicker1">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Address</label>
                                        <div class="col-sm-8">
                                            <textarea name="sender_address" readonly id="sender_address" class="form-control"><?= $booking->sender_address ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="sender_contactno" readonly id="sender_contactno" value="<?= $booking->sender_contactno ?>" class="form-control ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">TypeOfDoc<span class="compulsory_fields">*</span></label>
                                        <div class="col-sm-4">
                                            <select name="type_of_doc" readonly class="form-control">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="sender_gstno" readonly value="<?= $booking->sender_gstno; ?>"  id="sender_gstno" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="reciever_name" readonly id="reciever" value="<?= $booking->reciever_name ?>" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Company<span class="compulsory_fields">*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" readonly value="<?= $booking->contactperson_name ?>" name="contactperson_name" id="contactperson_name" required />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Address</label>
                                        <div class="col-sm-8">
                                            <textarea name="reciever_address" id="reciever_address" readonly class="form-control" autocomplete="off"><?= $booking->reciever_address ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Pincode<span class="compulsory_fields">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">ContactNo.</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" readonly value="<?= $booking->reciever_contact;?>" name="reciever_contact" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">GST NO.</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="receiver_gstno" id="receiver_gstno" readonly value="<?= $booking->receiver_gstno;?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="no_of_pack" readonly class="form-control my-colorpicker1 no_of_pack" data-attr="1" id="no_of_pack1" value="<?php echo $weight->no_of_pack; ?>" required="required">
                                                </div>
                                                <label class="col-sm-2 col-form-label">Actual Weight</label>
                                                <div class="col-sm-4">
                                                    <input type="text" name="actual_weight" readonly class="form-control my-colorpicker1 actual_weight" data-attr="1" id="actual_weight" value="<?php echo $weight->actual_weight; ?>" required="required">
                                                </div>
                                                <label class="col-sm-2 col-form-label">Chargeable Weight</label>
                                                <div class="col-sm-4">
                                                    <input type="text" name="chargable_weight" readonly class="form-control my-colorpicker1 chargable_weight" data-attr="1" id="chargable_weight" value="<?php echo $weight->chargable_weight; ?>" required="required">
                                                </div>
                                                <label class="col-sm-2 col-form-label">Is Volumetric</label>
                                                <div class="col-sm-4">
                                                        <?php $length_detail =  json_decode($weight->length_detail); ?>
                                                    <input type="checkbox" id="is_volumetric" readonly name="fav_language" <?php if($booking->doc_type=='1'){echo 'checked'; } ?><?php echo (!empty($length_detail[0])) ? 'checked' : ''; ?> >
                                                ...
                                                <table class="weight-table">
                                                    <thead>
                                                        ...
                                                        <?php
															...
															?>
                                                            <tr>
                                                                <td><input type="text" name="per_box_weight_detail[]" readonly class="form-control per_box_weight valid" data-attr="<?php echo ($jd + 1); ?>" id="per_box_weight<?php echo ($jd + 1); ?>"  aria-invalid="false" value="<?php echo $per_box_weight_detail[$jd]; ?>"></td>
                                                                <td class="length_td"><input type="text" readonly name="length_detail[]" class="form-control length"  data-attr="<?php echo ($jd + 1); ?>" id="length<?php echo ($jd + 1); ?>" value="<?php echo $length_detail[$jd]; ?>" ></td>
                                                                <td class="breath_td"><input type="text" readonly name="breath_detail[]" class="form-control breath" data-attr="<?php echo ($jd + 1); ?>" id="breath<?php echo ($jd + 1); ?>" value="<?php echo $breath_detail[$jd]; ?>" ></td>
                                                                <td class="height_td"><input type="text" readonly name="height_detail[]" class="form-control height" data-attr="<?php echo ($jd + 1); ?>" id="height<?php echo ($jd + 1); ?>" value="<?php echo $height_detail[$jd]; ?>" ></td>
                                                                <td class="volumetic_weight_td"><input type="text" readonly name="valumetric_weight_detail[]" readonly class="form-control valumetric_weight" data-attr="<?php echo ($jd + 1); ?>" id="valumetric_weight<?php echo ($jd + 1); ?>" value="<?php echo $valumetric_weight_detail[$jd]; ?>"></td>

                                                                <td class="volumetic_weight_td"><input type="text" readonly name="valumetric_actual_detail[]" class="form-control valumetric_actual" data-attr="<?php echo ($jd + 1); ?>" id="valumetric_actual<?php echo ($jd + 1); ?>" value="<?php echo $weight_details['valumetric_actual_detail'][$jd]; ?>"></td>

                                                                <td class="volumetic_weight_td"><input type="text" readonly name="valumetric_chageable_detail[]" readonly class="form-control valumetric_chageable" data-attr="<?php echo ($jd + 1); ?>" id="valumetric_chageable<?php echo ($jd + 1); ?>" value="<?php echo $weight_details['valumetric_chageable_detail'][$jd]; ?>"></td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
                                                    <tfoot>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group row" id="payby" style="display:none;">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <select class="form-control" readonly name="payment_method" id="payment_method">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group row" id="Refno" style="display:none;">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="ref_no" readonly class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6">

                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <?php $customer_id = $_SESSION['customer_id']; $readonly = $this->db->query("SELECT * FROM tbl_branch_assign_cnode WHERE customer_id = '$customer_id'")->row(); ?>
                                    <div class="form-group row">
                                       <label class="col-sm-4 col-form-label">Airway No<span class="compulsory_fields">*</span></label>
                                       <div class="col-sm-8">
                                            <input type="text" name="awn"  class="form-control pod" value="" <?php if(empty($readonly)){ echo 'readonly';  }else{ ?> id="pod" <?php } ?> pattern="[a-zA-Z]" required autocomplete="off" style="text-transform: uppercase;">
                                            <!-- <input type="hidden" name="awn" id="awn" class="form-control" value="<?php echo $bid ;?>"> -->
                                            <input type="hidden" name="courier_company" id="courier_company" class="form-control" value="51">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="sender_pincode" maxlength="6" minlength="6" id="sender_pincode" value="<?= $balance->pincode; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="chargable_weight" class="form-control my-colorpicker1 chargable_weight" data-attr="1" id="chargable_weight" autocomplete="off" required="required">
                                                </div>
                                                ...
                                                <table class="weight-table">
                                                    <thead>
                                                        ...
                                                        <tbody id="volumetric_table_row">
                                                            <tr>
                                                                <td><input type="text" name="per_box_weight_detail[]" autocomplete="off" class="form-control per_box_weight valid" data-attr="1" id="per_box_weight1" aria-invalid="false"></td>

            ...
            <div class="card-body">
                <div class="row p-2">
                    <div class="col-md-6">
                        ...
                        <a href="<?= base_url('franchise/rate-calculator')?>" class="btn btn-sm btn-success" style="background:#12263f!important;color:#fff; border: 1px solid #12263f!important;">Reset</a>
                    </div>
                </div>
                <hr>

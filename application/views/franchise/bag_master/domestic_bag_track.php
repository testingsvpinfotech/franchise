    ...
    <div class="col-12  align-self-center">
        ...
        <div class="card">
            <div class="card-header justify-content-between align-items-center">
                <h4 class="card-title">Franchise Bag Tracking</h4>  
							<span style="float: right;">
							 <form method='post' action="<?= base_url('franchise/tracking-franchise-bag'); ?>">
										...
										<a href="<?= base_url('franchise/download-franchise-tracking-bag/'.$manifiest[0]['bag_id']); ?>"  class="btn btn-info">Download </a>	
										<?php } ?>
                                            ...
                                            <div class="card-body table-responsive" style="border:1px solid;">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td >
															<center> <?php  $city = $branchAddress[0]['city']; $city_name =$this->db->query("select * from city where id = '$city'")->row();?>
                                                              <strong style="font-size: 35px;width: 150px;"> <img src="<?php echo base_url('assets/company/').'/'.$company_details->logo; ?>" class="portfolioImage img-fluid" > </strong><br><br>
                                                                    <p class="fontm">ADDRESS : <?php echo $branchAddress[0]['address']; ?> <?php echo ($city_name->city!='') ? ", ".$city_name->city : '' ; ?>, <?php echo $branchAddress[0]['pincode']; ?></p> 
                                                                <p style="font-size: 19px;color: black;">  
                                                                <b>Telephone: </b><?php echo $branchAddress[0]['contact_person'];?><br>

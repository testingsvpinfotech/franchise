                            ...
                            ?>
                               <tr class="odd">
                                 <td><?php echo $cnt; ?></td>
                                  ...
                                  <td><a href="../assets/franchise_pod/<?php echo $row->image; ?>" target="_blank">View Pod Image</a></td>
                                  <!-- <td><a href="../assets/franchise_pod/<?php echo $row->image; ?>" src="../assets/franchise_pod/<?php echo $row->image; ?>" title="<?php echo $row->pod_no;?>" onclick="show_image(this);return false;">View Pod Image</a></td> -->
                                  <!-- <td><a href="<?= base_url('assets/franchise_pod/'.$row->image); ?>" src="<?= base_url('assets/franchise_pod/'.$row->image); ?>" title="<?php echo $row->pod_no; ?>" onclick="show_image(this);return false;">View Pod Image</a></td> -->

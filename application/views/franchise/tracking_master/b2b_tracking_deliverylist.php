               ...
               <?php  include(dirname(__FILE__).'/../tracking_master/b2b_tracking_tab.php'); ?>
                ...
                <div class="table-responsive">
                    <table id="id1" class="display table  table-striped ">
                        ...
                        <tbody>
                            <?php // print_r($delivery_list);?>
                            <?php if(!empty($delivery_list)){?>
                            <?php foreach( $delivery_list as $value):?>
                            <tr>
                                ...
                                <td> <?php if($value['status'] == 'Out For Delivery'){?> <button type="button" class="btn btn-outline-info btn-sm">Out for Delivery</button> <?php }?></td>
                            </tr>
                            <?php endforeach ;?>
                          <?php }else { ?> 

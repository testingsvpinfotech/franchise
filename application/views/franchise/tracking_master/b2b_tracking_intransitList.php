               ...
               <?php  include(dirname(__FILE__).'/../tracking_master/b2b_tracking_tab.php'); ?>
                ...
                <div class="table-responsive">
                    <table id="id1" class="display table  table-striped ">
                        ...
                        <tbody>
                            <?php //  print_r($intransite_list);?>
                            <?php if(!empty($intransite_list)){?>
                            <?php foreach( $intransite_list as $value):?>
                            <tr>
                                ...
                                <td> <?php if($value['status'] == 'shifted'){?> <button type="button" class="btn btn-outline-info btn-sm">In-transit</button> <?php }?></td>
                            </tr>
                            <?php endforeach ;?>
                          <?php }else { ?> 

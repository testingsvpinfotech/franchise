               ...
               <?php  include(dirname(__FILE__).'/../tracking_master/b2b_tracking_tab.php'); ?>
                ...
                <div class="table-responsive">
                    <table id="id1" class="display table  table-striped ">
                        ...
                        <tbody>
                            <?php // print_r($booked_list);?>
                            <?php if(!empty('$booked_list')){?>
                            <?php foreach( $booked_list as $value):?>
                            <tr>
                                ...
                                <td> <?php if($value['status'] == 'Booked'){?> <button type="button" class="btn btn-outline-info btn-sm">booked</button> <?php }?></td>
                            </tr>
                            <?php endforeach ;?>
                          <?php }else { ?> 

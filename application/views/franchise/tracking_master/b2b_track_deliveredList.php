               ...
               <?php  include(dirname(__FILE__).'/../tracking_master/b2b_tracking_tab.php'); ?>
                ...
                <div class="table-responsive">
                    <table id="id1" class="display table  table-striped ">
                        ...
                        <tbody>
                            <?php // print_r($delivered_list);?>
                            <?php if(!empty($delivered_list)){?>
                            <?php foreach( $delivered_list as $value):?>
                            <tr>
                                ...
                                <td> <?php if($value['status'] == 'Delivered'){?> <button type="button" class="btn btn-outline-info btn-sm">Delivered </button> <?php }?></td>
                            </tr>
                            <?php endforeach ;?>
                          <?php }else { ?> 

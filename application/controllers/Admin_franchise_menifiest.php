...
class Admin_franchise_menifiest extends CI_Controller {
	...
	{			
		...
		//  print_r('hello');die;
		 $this->load->view('franchise/Menifiest_master/view_menifiest',$data);
	}	
	...
	{ 
		...
		$this->load->view('franchise/Menifiest_master/addmenifiest', $data);	
	}
	...
	public function insert_menifiest()
	{
        ...
        {	
			...
			redirect('franchise/list-domestic-menifiest');
		}	
	...
	public function view_manifest_delivery_status2()
	{
	    ...
	    $this->load->view('franchise/Menifiest_master/manifest_delivery_status2',$data);
	}

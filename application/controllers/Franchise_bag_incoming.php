...
class Franchise_bag_incoming extends CI_Controller
{
	...
	public function incomingbag()
	{
		...
		$this->load->view('masterfranchise/bag_incoming/view_incoming', $data);
	}
	...
	public function addincomingbag($mid = '')
	{
		...
		if (isset($_POST['receving'])) {
			...
			redirect('master_franchise/list-incoming-bag');
		}


		$this->load->view('masterfranchise/bag_incoming/addincoming', $data);
	}

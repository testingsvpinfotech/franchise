...
class Master_Franchise_prq extends CI_Controller {
	...
	public function pickup_request()
	{
		...
		if (isset($_POST['submit'])){
          ...
          //  print_r($count);exit;
			...
			redirect('Master_Franchise_prq/pickup_request');
		}
		...
		$this->load->view('masterfranchise/customer_prq/add_pickup_request',$data);
	...
	public function view_pickup_request()
	{
		...
		// echo $this->db->last_query();exit;
		$this->load->view('masterfranchise/customer_prq/view_pickup_request',$data);

                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="uthead lftredbrdr">
                            <h3 style="color: #c5792f;">Unbeatable Justlog Services</h3>
                        </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <p> <i class="fa fa-angle-double-right" aria-hidden="true" style="color:#f6bd63"></i>  Justlog is the world’ s leading logistic service company, We have a wide experience in overland industry specific logistic solutions like pharmaceutical logistics, retail and automotive logistics by train or road.</p>
                        <p> <i class="fa fa-angle-double-right" aria-hidden="true" style="color:#f6bd63"></i>  We bring your goods safely to worldwide destinations with our great sea fright services.We offer LLC and FLC shipments that are fast and effective with no delays.</p>
                    </div>
                </div>
            </div>
        </div>

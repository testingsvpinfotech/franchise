            ...
            <div class="row">
                <div class="col-lg-12 sm-mb-45px">
                    <div class="section-title-right text-main-color clearfix">
                        ...
                        <h2 class="title-text">We are JUSTLOG  ?</h2>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                        <div class="service-icon-box">
                            ...
                            <div class="des">JUSTLOG Logistics offers specialized and reliable cost-effective Domestic & International fast air logistics services in India for time-sensitive</div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-icon-box">
                            ...
                            <div class="des">International freight forwarding with JUSTLOG Logistics personalised to suit you. We look after your logistics needs so you can focus on your core business responsibilities.</div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-icon-box">
                        ...
                        <div class="des">Surface Logistics is basically transferring goods from one place to another via Road. The Surface freight services are the most common option that deliver your goods on time with JUSTLOG Logistics.</div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-icon-box">
                        ...
                        <div class="des">Warehousing refers to a storage system used for protecting the quantity and quality of the stored products. JUSTLOG Logistics have own warehouse facility at different differnt locations.</div>
                    </div>
                </div>
            </div>

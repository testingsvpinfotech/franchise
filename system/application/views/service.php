                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="uthead lftredbrdr">
                            <h3 style="color: #c5792f;">Services</h3>
                        </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <p> <i class="fa fa-angle-double-right" aria-hidden="true" style="color:#f6bd63"></i>   Box N Freight begin its journey to give integrated
                        logistical solutions, through new processes, technology, and system. we provide 
                        services in all of India.</p>
                        <p> <i class="fa fa-angle-double-right" aria-hidden="true" style="color:#f6bd63"></i>   We make ensure that to provide the most-effective transportation solution that adds value to your client in your supply chain system.</p>
                        <p> <i class="fa fa-angle-double-right" aria-hidden="true" style="color:#f6bd63"></i>   We had to make our presence in this segment of the logistics business with a value added services to all our customers.</p>
                     <p> <i class="fa fa-angle-double-right" aria-hidden="true" style="color:#f6bd63"></i>   Box N Freight Logistcs Solution, We offer a services
                      <ul>
                        <li> Road transportation</li>
                        <li> Air transportation</li>
                        <li>  Ship transportation </li>
                        <li>Courier & Cargo</li>
                        <li>Domestic & International</li>
                        <li>Rail Logistics</li>
                        <li>Third Party Logistics</li>
                        <li>Road Transport with all type of Vehicles</li>
                        <li>Warehousing</li>
                    </ul>   
 </p>
                    </div>
                    ...
                    <div class="service-list row">
                        <div class="item-service  col-xs-12 col-sm-6 col-md-4">
                            <div class="service-content">
                                ...
                                <div class="summary">
                                    ...
                                    <p>Box N Freight are transported at some stage of their journey along the world’s roads where we give you a presence.</p>
                        ...
                        <div class="item-service  col-xs-12 col-sm-6 col-md-4">
                            <div class="service-content">
                                ...
                                <div class="summary">
                                    ...
                                    <p>As a leader in global air freight forwarding, Box N Freight excels in providing tailored transportation</p>
                                    <a href="#" class="read-more">Read More...</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item-service  col-xs-12 col-sm-6 col-md-4">
                            <div class="service-content">
                                ...
                                <div class="summary">
                                    <h2 class="entry-title"><a href="#">Box N Freight Service</a></h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="abotimglft">
                            <img src="<?php echo base_url();?>assets/web_assets/images/resources/warehouse.png" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="abotinforgt">
                            <div class="fh-section-title f30 clearfix  text-left version-dark paddbtm30">
                                <h2>The Complete Warehouse Solution</h2>
                            </div>

...
jQuery(document).ready(function() {
	...
	$("#frieht,#transportation_charges,#pickup_charges,#delivery_charges,#courier_charges,#awb_charges,#other_charges,#insurance_charges,#green_tax,#appt_charges,#fuel_charges").change(function () {
            ...
            // alert(fov_charges);
			var totalAmount = (
				frieht + transportation_charges + pickup_charges + delivery_charges + courier_charges +awb_charges + other_charges + fov_charges + insurance_charges + green_tax + appt_charges + fuel_charges
				);
				//alert(fov_charges);
	...
	function calculateTotalWeight() 
	{
		...
		for (var i = 1; i <= totalRow; i++) 
		{
			...
			if (length != '' && breath != '' && height != '' ) 
			{
				...
				//	valumetric_weight = Math.ceil(valumetric_weight);
				}
				else
				{
					air_cft = $('#air_cft').val();
